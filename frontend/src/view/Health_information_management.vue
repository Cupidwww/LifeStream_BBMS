    ...
    <div>
        ...
        <!-- 查询表单 -->
            <el-form :model="searchQuery" label-width="120px" class="search-form">
                ...
                <el-form-item label="Staff ID">
                    <el-input v-model="searchQuery.staffID" type="number" />
                </el-form-item>

                <el-form-item label="Donor ID" >
                    <el-input v-model="searchQuery.donorID" type="number" placeholder="Enter Donor ID" />
                </el-form-item>
                ...
                <el-form-item label="Height">
                    <el-input v-model="searchQuery.height" type="number" placeholder="Enter Height" />
                </el-form-item>

                <el-form-item label="Weight">
                    <el-input v-model="searchQuery.weight" type="number" placeholder="Enter Weight" />
                </el-form-item>

                <el-form-item label="Hepatitis B">
                    <el-select v-model="searchQuery.hepatitisB" placeholder="Select Hepatitis B Status">
                ...
                <el-form-item label="HIV">
                    <el-select v-model="searchQuery.hiv" placeholder="Select HIV Status">
                        <el-option label="Yes" value="yes" />
                        <el-option label="No" value="no" />
                    </el-select>
                </el-form-item>

                <el-form-item label="Syphilis">
                    <el-select v-model="searchQuery.syphilis" placeholder="Select Syphilis Status">
                        <el-option label="Yes" value="yes" />
                        <el-option label="No" value="no" />
                    </el-select>
                </el-form-item>

                <el-form-item label="Physical Exam">
                    <el-select v-model="searchQuery.physicalExamResult" placeholder="Select Exam Result">
                ...
                <!-- <el-form-item label="Physical Exam Time" :rules="[{ required: true, message: 'Physical Exam Time is required', trigger: 'blur' }]">
                    <el-date-picker v-model="searchQuery.physicalExamTime" type="datetime" placeholder="Select Date and Time" />
                </el-form-item> -->

                <el-form-item label="Test Result">
                    <el-input v-model="searchQuery.testResult" />
                </el-form-item>

                <!-- <el-form-item label="Test Time" :rules="[{ required: true, message: 'Test Time is required', trigger: 'blur' }]">
                    <el-date-picker v-model="searchQuery.testTime" type="datetime" placeholder="Select Test Date and Time" />
                </el-form-item> -->

                <el-form-item label="Test Tube NO.">
                    <el-input v-model="searchQuery.testTubeNumber" type="number" />
                </el-form-item>
        ...
        :close-on-click-modal="false">
            <el-form :model="newRecord" label-width="auto">
                ...
                <el-form-item label="Height" class="dialog-label" :rules="[{ required: true, message: 'Height is required', trigger: 'blur' }]">
                    <el-input v-model="newRecord.height" type="number" />
                </el-form-item>

                <el-form-item label="Weight" class="dialog-label" :rules="[{ required: true, message: 'Weight is required', trigger: 'blur' }]">
                    <el-input v-model="newRecord.weight" type="number" />
                </el-form-item>

                <el-form-item label="Hepatitis B" class="dialog-label" :rules="[{ required: true, message: 'Hepatitis B status is required', trigger: 'blur' }]">
                ...
                <el-form-item label="HIV" class="dialog-label" :rules="[{ required: true, message: 'HIV status is required', trigger: 'blur' }]">
                ...
                <el-form-item label="Syphilis" class="dialog-label" :rules="[{ required: true, message: 'Syphilis status is required', trigger: 'blur' }]">
                ...
                <el-form-item label="Physical Exam Result" class="dialog-label" :rules="[{ required: true, message: 'Physical Exam Result is required', trigger: 'blur' }]">
                ...
                <el-form-item label="Physical Exam Time" class="dialog-label" :rules="[{ required: true, message: 'Physical Exam Time is required', trigger: 'blur' }]">
                    <el-date-picker v-model="newRecord.physicalExamTime" type="datetime" placeholder="Select Date and Time" />
                </el-form-item>

                <el-form-item label="Test Result" class="dialog-label">
                    <el-input v-model="newRecord.testResult" />
                </el-form-item>

                <el-form-item label="Test Time" class="dialog-label" :rules="[{ required: true, message: 'Test Time is required', trigger: 'blur' }]">
                    <el-date-picker v-model="newRecord.testTime" type="datetime" placeholder="Select Test Date and Time" />
                </el-form-item>

                <el-form-item label="Test Tube Number" class="dialog-label" :rules="[{ required: true, message: 'Test Tube Number is required', trigger: 'blur' }]">
...
export default {
    ...
    methods: {
        ...
        async handleUpdateRecord() {
            ...
            if (this.editRecord.donorID !== null) {
                this.editRecord.donorID = Number(this.newRecord.donorID);
                }
                if (this.editRecord.staffID !== null) {
                    this.editRecord.staffID = Number(this.newRecord.staffID);
                }   
                if (this.editRecord.physicalExamTime) {
                    this.editRecord.physicalExamTime = this.formatDate(this.editRecord.physicalExamTime);
                }
                if (this.editRecord.testTime) {
                    this.editRecord.testTime = this.formatDate(this.editRecord.testTime);
                }
            try {
        ...
        async handleAddRecord() {
            ...
            if (this.newRecord.physicalExamTime) {
                this.newRecord.physicalExamTime = this.formatDate(this.editRecord.physicalExamTime);
            }
            if (this.newRecord.testTime) {
                this.newRecord.testTime = this.formatDate(this.editRecord.testTime);
            }
            try {
        ...
        async handleSearch() {
            ...
            try {
                // 确保数字字段是正确类型
                if (this.searchQuery.donorID !== null) {
                    this.searchQuery.donorID = Number(this.searchQuery.donorID);
                }
                if (this.searchQuery.staffID !== null) {
                    this.searchQuery.staffID = Number(this.searchQuery.staffID);
                }
                if (this.searchQuery.physicalExamTime) {
                    this.searchQuery.physicalExamTime = this.formatDate(this.searchQuery.physicalExamTime);
                }
                if (this.searchQuery.testTime) {
                    this.searchQuery.testTime = this.formatDate(this.searchQuery.testTime);
                }
                const response = await healthApi.getFullList(this.searchQuery);
